    ...
    <section id="contact" style={{ padding: "72px 0", background: "var(--carbon)" }}>
      <div className="container-site">
        ...
        <AnimatedSection>
          <SectionHeader
            tag="Contact"
            title={lang === "fr" ? "Parlez-nous de votre projet" : "Tell us about your project"}
            subtitle={
              lang === "fr"
                ? "On vous répond sous 24h avec une proposition claire."
                : "We'll get back to you within 24h with a clear proposal."
            }
          />
        </AnimatedSection>
        ...
        <AnimatedSection delay={0.1}>
          <div className="contact-grid">
            ...
            <div>
              ...
              <div style={{ marginTop: "1.75rem", display: "flex", flexDirection: "column", gap: "0.65rem" }}>
                {[
                  ...
                  <div
                    key={info.text}
                    style={{ display: "flex", alignItems: "center", gap: "0.7rem", fontSize: "0.8rem", color: "var(--muted)" }}
                  >
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "0.65rem" }}>
              <div className="form-row-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.65rem" }}>
                <div>
                  <label style={labelStyle}>{lang === "fr" ? "Nom" : "Name"}</label>
                  <input
                    name="name" value={form.name} onChange={handleChange} required
                    placeholder={lang === "fr" ? "Votre nom" : "Your name"} style={inputStyle}
              ...
              <div>
                ...
                <input
                  ...
                  placeholder={lang === "fr" ? "Ex: dans 2 semaines" : "Ex: in 2 weeks"} style={inputStyle}
                  onFocus={(e) => (e.target.style.borderColor = "var(--teal-border)")}
                  onBlur={(e) => (e.target.style.borderColor = "var(--border)")}
                />
              </div>
              ...
              <button
                ...
                onMouseEnter={(e) => { if (state.status !== "loading") e.currentTarget.style.opacity = "0.85"; }}
